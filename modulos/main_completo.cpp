...
// BARGRAPH - 8 LEDs em PORTD (PD0-PD4, PD7)
// ATENÇÃO: PD5 e PD6 são usados pelo CRISTAL (XTAL1/XTAL2) - NÃO CONECTAR LEDs!
// Mapeamento de hardware:
// PD0=LED0, PD1=LED1, PD2=LED2, PD3=LED3, PD4=LED4, PD7=LED7
// PD5 e PD6 estão RESERVADOS para o cristal de 16MHz
...
// ATENÇÃO: NÃO usar PD5 e PD6 (reservados para cristal XTAL1/XTAL2)
// Usando pinos alternativos em PORTB para evitar conflito
#define LED_BTN1    PB0    // Alterado de PD3 para usar PORTB
#define LED_BTN2    PB1    // Alterado de PD4 para usar PORTB
#define LED_BTN3    PB2    // Alterado de PD5 para usar PORTB
...
void setup() {
    // PORTD como saída, mas PD5 e PD6 serão configurados corretamente
    // ATENÇÃO: PD5 e PD6 são usados pelo cristal (XTAL1/XTAL2)
    // Configurar apenas PD0-PD4 e PD7 como saída para LEDs
    DDRD = 0b10011111;  // PD7, PD4, PD3, PD2, PD1, PD0 como saída
    PORTD = 0x00;
    
    // PORTB como saída (compartilhado entre displays de 7 segmentos e LEDs de botões)
    // PB0-PB2: LEDs de botões
    // PB0-PB7: Segmentos dos displays (quando displays ativos)
    DDRB = 0xFF;
    PORTB = 0x00;
    ...
    // LEDs de botões agora em PORTB (PB0-PB2)
 ...
 *        ⚠️  ATENÇÃO: PD5 (pino 11) e PD6 (pino 12) são RESERVADOS para o CRISTAL!
 *        ⚠️  NÃO conectar LEDs em PD5 e PD6 - causará curto-circuito!
 *        
 *    - CRISTAL (16MHz):
 *        * Pino 9  (XTAL1/PB6) ─┬─ Cristal 16MHz
 *        * Pino 10 (XTAL2/PB7) ─┘  + capacitores de 22pF
 *    
 *    - MÓDULO 2 (Displays de 7 Segmentos):
 *        * Segmentos a-g+dp em PB0-PB7 (compartilhado com LEDs de botões)
 *        * Seleção de displays em PC0-PC1 (transistores para multiplexação)
 *        
 *    - MÓDULO 3 (Botões):
 *        * Botões em PC2-PC4 com pull-up interno habilitado
 *        * LEDs de botões em PB0-PB2 com resistores de 220Ω
 *          (compartilhado com segmentos dos displays)
 * 
 * ================================================================================
 */
